...
| Week | Topic | Files |
|------|-------|-------|
| Week 0 | Functions, Variables | [`indoor`](indoor.py), [`playback`](playback.py), [`faces`](faces.py), [`einstein`](einstein.py), [`tip`](tip.py) |
| Week 1 | Conditionals | [`deep`](deep.py), [`bank`](bank.py), [`meal`](meal.py), [`extensions`](extensions.py), [`interpreter`](interpreter.py) |
| Week 2 | Loops | [`camel`](camel.py), [`coke`](coke.py), [`twttr`](twttr.py), [`nutrition`](nutrition.py), [`plates`](plates.py) |
| Week 3 | Exceptions | [`fuel`](fuel.py), [`grocery`](grocery.py), [`outdated`](outdated.py), [`taqueria`](taqueria.py) |
| Week 4 | Libraries | [`emojize`](emojize.py), [`figlet`](figlet.py), [`adieu`](adieu.py), [`game`](game.py), [`professor`](professor.py) |
| Week 5 | Unit Tests | [`test_twttr`](test_twttr.py) + [`twttr`](twttr.py), [`test_bank`](test_bank.py) + [`bank`](bank.py), [`test_plates`](test_plates.py) + [`plates`](plates.py), [`test_fuel`](test_fuel.py) + [`fuel`](fuel.py) |
| Week 6 | File I/O | [`lines`](lines.py), [`pizza`](pizza.py), [`scourgify`](scourgify.py), [`shirt`](shirt.py) |
| Week 7 | Regular Expressions | [`numb3rs`](numb3rs.py), [`watch`](watch.py), [`um`](um.py), [`working`](working.py), [`response`](response.py) |
| Week 8 | Object-Oriented Programming | [`jar`](jar.py), [`seasons`](seasons.py), [`shirtificate`](shirtificate.py) |
| Week 9 | Final Project | [`project`](project.py) |
...
**[`test_twttr.py`](test_twttr.py) + [`twttr.py`](twttr.py) — "Testing my twttr"** *(revisits Week 2)*
...
**[`test_bank.py`](test_bank.py) + [`bank.py`](bank.py) — "Back to the Bank"** *(revisits Week 1)*
...
**[`test_plates.py`](test_plates.py) + [`plates.py`](plates.py) — "Re-requesting a Vanity Plate"** *(revisits Week 2)*
...
**[`test_fuel.py`](test_fuel.py) + [`fuel.py`](fuel.py) — "Refueling"** *(revisits Week 3)*
...
**[`project.py`](project.py) — Simple Moving Average Crossover Backtest**
